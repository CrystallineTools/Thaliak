...
namespace Thaliak.Database.Migrations
{
    ...
    [Migration("20220619040744_AddOrphanedPatchesView")]
    partial class AddOrphanedPatchesView
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thaliak.Database.Models.XivPatchChain", b =>
                {
                    b.Property<int>("RepositoryId")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("HasPrerequisitePatch")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("LastOffered")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("RepositoryId", "PatchId", "PreviousPatchId");
            ...
            modelBuilder.Entity("Thaliak.Database.Models.XivPatchChain", b =>
                {
                    b.HasOne("Thaliak.Database.Models.XivPatch", "Patch")
                        .WithMany("PrerequisitePatches")
                        .HasForeignKey("PatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Thaliak.Database.Models.XivPatch", "PreviousPatch")
            ...
            modelBuilder.Entity("XivFileXivVersion", b =>
                {
                    b.HasOne("Thaliak.Database.Models.XivFile", null)
                        .WithMany()
                        .HasForeignKey("FilesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Thaliak.Database.Models.XivVersion", null)
                        .WithMany()
