...
namespace Thaliak.Common.Database.Migrations
{
    ...
    [Migration("20221208081632_ConvertToSnakeCase_Deux")]
    partial class ConvertToSnakeCase_Deux
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivPatch", b =>
                {
                    ...
                    b.HasIndex("VersionId")
                        .HasDatabaseName("ix_patches_version_id");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivPatchChain", b =>
                {
                    ...
                    b.HasIndex("RepositoryId")
                        .HasDatabaseName("ix_patch_chains_repository_id");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivRepository", b =>
                {
                    ...
                    b.Property<int>("ServiceRegionId")
                        .HasColumnType("integer")
                        .HasColumnName("service_region_id");
                    ...
                    b.HasIndex("ServiceRegionId")
                        .HasDatabaseName("ix_repositories_service_region_id");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivServiceRegion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivVersion", b =>
                {
                    ...
                    b.HasIndex("RepositoryId")
                        .HasDatabaseName("ix_versions_repository_id");

                    b.HasIndex("VersionId")
                        .HasDatabaseName("ix_versions_version_id");

                    b.HasIndex("VersionString")
                        .HasDatabaseName("ix_versions_version_string");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivPatch", b =>
                {
                    ...
                    b.HasOne("Thaliak.Common.Database.Models.XivVersion", "Version")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_patches_versions_version_id");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivPatchChain", b =>
                {
                    ...
                    b.HasOne("Thaliak.Common.Database.Models.XivRepository", "Repository")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_patch_chains_repositories_repository_id");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivRepository", b =>
                {
                    b.HasOne("Thaliak.Common.Database.Models.XivServiceRegion", "ServiceRegion")
                        .WithMany("Repositories")
                        .HasForeignKey("ServiceRegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_repositories_service_regions_service_region_id");
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivVersion", b =>
                {
                    b.HasOne("Thaliak.Common.Database.Models.XivRepository", "Repository")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_versions_repositories_repository_id");
            ...
            modelBuilder.Entity("XivFileXivVersion", b =>
                {
                    b.HasOne("Thaliak.Common.Database.Models.XivVersion", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_version_files_versions_versions_id");
